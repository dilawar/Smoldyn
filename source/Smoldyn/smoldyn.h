...
#ifdef OPTION_VCELL
  valueproviderptr
      *srfRateValueProvider; // rate for surface actions: asorption,
...
typedef struct bngstruct {
  ...
  surfactionptr **
      *monomeractdetails; // monomer action details [index][srf][face]
...
typedef struct simstruct {
  ...
  assignmols2boxesfnptr
      assignmols2boxesfn;         // function that assigns molecs to boxes
...
public:
  ...
  virtual double getValue(double t, double x, double y, double z,
                          rxnptr rxn) = 0;
  virtual double getValue(double t, double x, double y, double z, rxnptr rxn,
                          char *panelName) = 0;
  virtual double getValue(double t, double x, double y, double z,
